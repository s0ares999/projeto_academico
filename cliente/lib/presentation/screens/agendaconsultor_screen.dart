...
class AgendaConsultorScreen extends StatefulWidget {
  @override
  _AgendaConsultorScreenState createState() => _AgendaConsultorScreenState();
}

class _AgendaConsultorScreenState extends State<AgendaConsultorScreen> {
  ...
  Future<void> _carregarPartidas() async {
    final response = await http.get(Uri.parse('https://pi4-hdnd.onrender.com/partidas'));
